...
BASE_SYSTEM_PROMPT = (
    ...
    "В каждом блоке кода ОБЯЗАТЕЛЬНО добавляй комментарии к ключевым строкам — "
    "объясняй на русском что делает код и почему. "
    "Логические блоки кода разделяй пустыми строками для читаемости."
)
