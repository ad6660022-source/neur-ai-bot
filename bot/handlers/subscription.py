...
PLAN_DETAILS = {
    ...
    "basic": {
        ...
        "limits": (
            ...
            "🔵 DeepSeek: 150/мес · 40/день\n"
            "🟣 Claude: недоступен\n"
            "🎨 Изображения: 40/мес · 3/день\n"
            "💾 Сохранение чатов: 5"
        ),
    },
    "pro": {
        ...
        "limits": (
            ...
            "🔵 DeepSeek: 400/мес · 80/день\n"
            "🎨 Изображения: 200/мес · 10/день\n"
            "💾 Сохранение чатов: 30"
        ),
    },
    "ultra": {
        ...
        "limits": (
            ...
            "🔵 DeepSeek: 2000/мес · 200/день\n"
            "🎨 Изображения: 450/мес · 25/день\n"
            "💾 Сохранение чатов: ∞"
        ),
    },
}
